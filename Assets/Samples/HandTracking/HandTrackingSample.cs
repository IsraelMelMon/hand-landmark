...

{
    ...
    void Start()
    {
        ...
        webcamTexture = new WebCamTexture(cameraName, 720, 640, 60);
    ...
    void Update()
    {
        ...
        if (landmarkResult == null || landmarkResult.score < 0.1f) return;
    ...
    void Invoke()
    {
        ...
        //Debug.Log(landmarkResult.GetResult());
    }
    ...
    void DrawJoints(Vector3[] joints)
    {
        ...
        //{
            ...
            //print(worldJoints[11]);  
        //}
        
        // ringJoint vector
        Vector3 ringJoint = (worldJoints[10]-worldJoints[9])*0.5f+worldJoints[9];
        // wristJoint vector
        Vector3 wristJoint = worldJoints[0];

        Vector3 palmMiddle =  (worldJoints[9]-worldJoints[0])*0.5f+worldJoints[0];
        
        
        // draw joints
        draw.Cube(wristJoint, 0.3f);
        draw.Cube(ringJoint, 0.3f);
        draw.Cube(palmMiddle,0.3f);
